    ...
    cart.forEach((movie, index) => {
      movieList += `
        <li>
          ...
          <button onclick="moveUp(${index})"> <img src="images/haut.png" alt="Monter"></button>
          <button onclick="moveDown(${index})"> <img src="images/bas.png" alt="Descendre"></button>
          <button onclick="removeMovie(${index})"> <img src="images/croix.png" alt="Supprimer"></button>
        </li>`;
    });
    movieList += '</ul>';
